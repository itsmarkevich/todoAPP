...
<body>
<a href="{{ route('tasks.show', $task->slug) }}" class="edit-btn" id="cancel-btn">
    Cancel
</a>
<div class="show-task-container">
    <form id="edit-form" method="POST" action="{{ route('tasks.update', $task->slug) }}" style="margin:0; padding:0;">
        @csrf
        @method('PATCH')
        <h2>Task edit</h2>
        <div>
    ...
    <div class="action-btns">
        ...
        <form method="POST" action="{{ route('tasks.destroy', $task->slug) }}" style="margin:0; padding:0;">
            @csrf
            @method('DELETE')
